#ifndef INFLECTOR_HDR
#define INFLECTOR_HDR
...
class Inflector : public Annotator {
    public:
        ...
        Inflector(const std::string& langCode, bool trainMode_, std::string modelFile_,
                int iterations_ = 50,
    ...
    private:
        class Worker : public LatticeWorker {
            public:
                Worker(Inflector& processor, Lattice& lattice);
            private:
                virtual void doRun();
                Inflector& processor_;
        };
